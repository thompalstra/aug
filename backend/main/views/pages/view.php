...
<div class="columns">
  <div class="column">
    <div class="block">
      ...
      <?=$form->field($model, "is_enabled")->checkboxInput()?>
    </div>
  </div>
</div>
...
<?=$form->end()?>
<script>
  this.setTitle("<i class='material-icons'>pageview</i>&nbsp;<?=$model->isNewRecord ? "Create page" : "Edit $model->name"?>");
