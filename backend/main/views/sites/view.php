...
<?=$form->end()?>
<script>
  this.setTitle("<i class='material-icons'>list</i>&nbsp;<?=$model->isNewRecord ? "Create site" : "Edit $model->name"?>");
